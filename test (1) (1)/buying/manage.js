...
add_product_btn.addEventListener("click", (e) => {
  ...
  console.log(product_name, price, image, product_type, description, isBestSeller);
  ...
  document.querySelectorAll(".btn-update").forEach((btn) => {
    btn.addEventListener("click", async (e) => {
      btn.onclick = async function () {
        ...
        document.getElementById("update_isBestSeller").checked = data.isBestSeller;
...
document.getElementById("update_product_btn").addEventListener("click", async (e) => {
  ...
  const isBestSeller = document.getElementById("update_isBestSeller").checked ;
